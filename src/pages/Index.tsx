...
import {SignInButton} from "../components/ui/signin"; // Make sure to
...
export default function Index() {
  ...
  // 1. Fetch the user directly from Convex (This handles both name and role!)
