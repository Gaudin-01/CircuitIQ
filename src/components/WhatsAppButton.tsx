...
export default function WhatsAppButton() {
  ...
  const message = "Hello! I have a question about CircuitIQ.";
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className={cn(
        "fixed bottom-18 right-2 z-[100]",
        "size-14 rounded-full p-2.5 shadow-lg hover:shadow-2xl transition-all duration-300",
        "bg-[#25D366]",
